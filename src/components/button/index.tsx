...
import { color as getColor, ColorPropType } from '../../system';
import { mergeProps, renderNode } from '../../utils';
...
export const Button = (props: ButtonProps & { theme: Theme }) => {
  const {
    type,
    color: colorProp,
    style: styleProp,
  ...
  const textStyle: TextStyle = StyleSheet.flatten([
    {
      color: type === 'solid' ? colors.white : textColor,
      textAlign: 'center',
