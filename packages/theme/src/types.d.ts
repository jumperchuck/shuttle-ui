...
export declare type WithThemeComponent<C extends ComponentType> = FC<
  WithThemeProps<ComponentProps<C>>
>;
export declare type WithThemeProps<P> = Omit<P, keyof ThemeContextType<any>>;
export declare type ThemeContextType<T> = {
  theme: T;
