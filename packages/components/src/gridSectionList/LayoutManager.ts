...
export default class LayoutManager<T, SectionT = DefaultSectionT> {
  constructor(
    ...
    public renderItem: GridSectionListRenderItem<T, SectionT>,
    public renderNoItem: GridSectionListRenderNoItem<T, SectionT> | undefined,
    public getItemLayout: (data: T[], index: number) => ItemLayout,
    public getSectionHeaderLayout:
      | ((section: GridSectionListData<T, SectionT>) => {
          length: number;
        })
      | undefined,
    public getSectionFooterLayout:
      | ((section: GridSectionListData<T, SectionT>) => {
          length: number;
        })
      | undefined,
